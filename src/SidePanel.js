...
const SidePanelItem = ({ iconSrc, text, notification }) => (
  <div className="h-11 items-center gap-3 px-4 py-3 rounded-[99px] overflow-hidden flex relative"></div>
);
...
export default function SidePanel() {
  return (
    <div className="sticky h-[678px] top-[30px] left-[30px] bg-[#f6f6fa] rounded-[37px] overflow-y-auto">
      ...
      <img
        className="sticky absolute w-[280px] h-px bottom-0 left-[27px]"
        alt="Line"
        src="/img/line-1.svg"
      />
      ...
      <Caret
        className="absolute w-5 h-5 top-[613px] left-[247px]"
        color="#081021"
      />
    </div>
  );
